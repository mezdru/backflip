  ...
  steps = [
    {
      ...
      intro: "<h2><strong>Human centric</strong></h2><p>Lenom is an app to find the <strong>Persons</strong> we are working with.</p><p class='align-right'>(basically, it's a directory)</p>",
